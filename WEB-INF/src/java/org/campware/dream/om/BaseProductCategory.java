...
public abstract class BaseProductCategory extends BaseObject
{
    ...
    private static final ProductCategoryPeer peer =
        ...
        /**
         * The value for the product_cat_name field
         */
        ...
        /**
         * Set the value of ProductCatName
         *
         * @param v new value
         */
        public void setProductCatName(String v) 
        {
          


         if (!ObjectUtils.equals(this.product_cat_name, v))
        {
             this.product_cat_name = v;
            setModified(true);
        }
    ...
    {
        getProducts().add(l);
        l.setProductCategory((ProductCategory) this);
    }
     ...
     * Otherwise if this ProductCategory has previously
    ...
    public List getProducts(Criteria criteria) throws TorqueException
    {
        if (collProducts == null)
        {
            ...
            {
                   criteria.add(ProductPeer.PRODUCT_CAT_ID, getProductCatId() );
    ...
    {
             save(ProductCategoryPeer.getMapBuilder()
     ...
     *
     * @param  product_cat_id ObjectKey
     */
    ...
    {
                    setProductCatId(Integer.parseInt(key));
            }
    ...
    {
        return SimpleKey.keyFor(getProductCatId());
    }
    ...
    protected ProductCategory copyInto(ProductCategory copyObj) throws TorqueException
    {
        ...
        copyObj.setProductCatName(product_cat_name);
