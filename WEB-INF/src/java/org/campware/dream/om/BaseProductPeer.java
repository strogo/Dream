    ...
    extends BasePeer
{
    ...
    /** the column name for the BASE_WEIGHT field */
    public static final String BASE_WEIGHT;
            ...
            throws TorqueException
    {
            ...
            criteria.addSelectColumn(BASE_WEIGHT);
        ...
        throws TorqueException
    {
        try
        {
                                        obj.setProductId(row.getValue(offset + 0).asInt());
                                            ...
                                            obj.setProductType(row.getValue(offset + 3).asInt());
                                            obj.setProductCatId(row.getValue(offset + 4).asInt());
                                            obj.setProductDescription(row.getValue(offset + 5).asString());
                                            obj.setProductDisplay(row.getValue(offset + 6).asString());
                                            obj.setBasePrice(row.getValue(offset + 7).asDouble());
                                            obj.setBaseWeight(row.getValue(offset + 8).asDouble());
    ...
    public static Criteria buildCriteria( Product obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
                       ...
                       criteria.add(PRODUCT_ID, obj.getProductId());
                                ...
                                criteria.add(BASE_WEIGHT, obj.getBaseWeight());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinProductCategory(Criteria c)
        throws TorqueException
    {
        ...
        ProductCategoryPeer.addSelectColumns(c);
                  ...
                  c.addJoin(ProductPeer.PRODUCT_CAT_ID,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinUom(Criteria c)
        throws TorqueException
    {
        ...
        ProductPeer.addSelectColumns(c);
        int offset = numColumns + 1;
        UomPeer.addSelectColumns(c);


                  c.addJoin(ProductPeer.UOM_ID,
            UomPeer.UOM_ID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinVendor(Criteria c)
        throws TorqueException
    {
        ...
        VendorPeer.addSelectColumns(c);
                  ...
                  c.addJoin(ProductPeer.VENDOR_ID,
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinAllExceptProductCategory(Criteria c)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinAllExceptUom(Criteria c)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinAllExceptVendor(Criteria c)
        throws TorqueException
    {
