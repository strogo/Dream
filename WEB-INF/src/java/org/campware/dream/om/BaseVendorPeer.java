    ...
    extends BasePeer
{
        ...
        throws TorqueException
    {
        try
        {
                                        obj.setVendorId(row.getValue(offset + 0).asInt());
                                            obj.setVendorName(row.getValue(offset + 1).asString());
                            }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Vendor retrieveByPK(int pk)
        throws TorqueException
    {
