...
public abstract class BaseTurbineRolePermission extends BaseObject
{
    ...
    {
        if (aTurbinePermission == null && (this.permission_id > 0))
        {
              aTurbinePermission = TurbinePermissionPeer.retrieveByPK(SimpleKey.keyFor(this.permission_id));
            ...
            /* The following can be used instead of the line above to
               ...
               As it can lead to a db query with many results that may
               never be used.
               TurbinePermission obj = TurbinePermissionPeer.retrieveByPK(this.permission_id);
               obj.addTurbineRolePermissions(this);
             */
        }
     ...
     */
    public void setPrimaryKey( int role_id, int permission_id)
        throws TorqueException
    {
         setRoleId(role_id);
    ...
    protected TurbineRolePermission copyInto(TurbineRolePermission copyObj) throws TorqueException
    {
        ...
        copyObj.setPermissionId(permission_id);
