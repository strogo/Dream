...
/**
  ...
  *
  */
public abstract class BaseTurbineScheduledJobPeer
    extends BasePeer
{
    ...
    {
        return getMapBuilder(TurbineScheduledJobMapBuilder.CLASS_NAME);
    }
    ...
    PROPERTY = "TURBINE_SCHEDULED_JOB.PROPERTY";
        ...
        {
            Torque.registerMapBuilder(TurbineScheduledJobMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "org.campware.dream.om.TurbineScheduledJob";
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseTurbineScheduledJobPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TurbineScheduledJob row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TurbineScheduledJob obj = (TurbineScheduledJob) cls.newInstance();
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(TurbineScheduledJobPeer.row2Object(row, 1,
                TurbineScheduledJobPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(TurbineScheduledJob obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TurbineScheduledJob obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TurbineScheduledJob obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TurbineScheduledJob obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TurbineScheduledJob) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TurbineScheduledJob obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TurbineScheduledJob) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TurbineScheduledJob obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TurbineScheduledJob) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TurbineScheduledJob obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TurbineScheduledJob obj )
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TurbineScheduledJob retrieveByPK(int pk)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TurbineScheduledJob retrieveByPK(ObjectKey pk)
        throws TorqueException
    {
        Connection db = null;
        TurbineScheduledJob retVal = null;
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TurbineScheduledJob retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException
    {
        ...
        {
            return (TurbineScheduledJob)v.get(0);
        }
    }
