...
/**
  ...
  *
  */
public abstract class BaseCountryPeer
    extends BasePeer
{
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Country row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(CountryPeer.row2Object(row, 1,
                CountryPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Country obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Country obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Country obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Country retrieveByPK(int pk)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Country retrieveByPK(ObjectKey pk)
        throws TorqueException
    {
        Connection db = null;
        Country retVal = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Country retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException
    {
